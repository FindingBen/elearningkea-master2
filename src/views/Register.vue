<template>
   <div>
      ...
      <button v-on:click="onSignup" class="btn btn-lg btn-primary btn-block" type="submit">Sign in</button>
      <br>
      <label for="">Already have an account?</label> <u><a href="http://localhost:8080/login">Log in</a></u>
